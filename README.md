...
Arduino TinyML project that uses a machine learning model to recognize digits in the camera feed, the model was trained using the MNIST dataset, [link to the project](https://studio.edgeimpulse.com/studio/537816).
